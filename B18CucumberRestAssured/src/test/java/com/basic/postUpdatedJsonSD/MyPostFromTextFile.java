...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
	    ...
	    data = new String(Files.readAllBytes(Paths.get("C:\\Users\\ksourabh\\eclipse-workspace1\\B18CucumberRestAssured\\src\\test\\java\\com\\basic\\postUpdatedJsonSD\\user.json")));
	    //String data1 = data;
